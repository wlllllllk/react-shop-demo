...
const Product = () => {
    ...
    const handleAddReview = () => {
        alert("TODO: write review");
    };

    const handleViewAllReview = () => {
        alert("TODO: view all review");
    };
                ...
                <div className="text">
                    ...
                    <div className="quantity">
                        ...
                        <span className="quantity-selector">
                            ...
                            ></button>
                            <input id="amount" type="text" value={amount} onChange={() => { }} />
                            <button
                                onClick={() => {
                    ...
                    <div className="add-button">
                        <button onClick={() => { alert("TODO: wishlist") }}>Add to Wishlist</button>
                ...
                <div className="both">
                    ...
                    <div className="right">
                        ...
                        <div className="reviews-container">
                            ...
                            <div className="view-all-reviews" onClick={handleViewAllReview}>View All Reviews</div>
                        </div>
                    </div>
                </div>
            </div>
