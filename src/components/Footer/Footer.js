            ...
            <div className="contents">
                <div className="sub-section" id="benefits">
                    ...
                    <div className="item" id="return">
                        <svg width="75" height="75" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M71.25 26.25V48.75C71.25 52.8863 67.89 56.25 63.75 56.25H11.25V45H60V30H18.75V37.5L3.75 24.375L18.75 11.25V18.75H63.75C65.7391 18.75 67.6468 19.5402 69.0533 20.9467C70.4598 22.3532 71.25 24.2609 71.25 26.25Z" fill="white" />
                        </svg>
